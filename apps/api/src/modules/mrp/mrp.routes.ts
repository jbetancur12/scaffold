...
export const createMrpRoutes = (orm: MikroORM) => {
    ...
    router.put('/purchase-orders/:id', (req, res, next) => mrpController.updatePurchaseOrder(req, res, next));
    ...
    router.get('/analytics/quotations/summary', (req, res, next) => mrpController.getQuotationAnalyticsSummary(req, res, next));
    ...
    router.get('/inventory/finished-goods-lots', (req, res, next) => mrpController.getFinishedGoodsLotInventory(req, res, next));
